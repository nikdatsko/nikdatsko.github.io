...
const LOAD_DATA_FAIL = '[Home] Load Data Fail';
class LoadData {
    constructor(payload) {
...
LoadDataSuccess.ctorParameters = () => [
    { type: undefined }
];
class LoadDataFail {
    constructor() {
...
let HomeEffects = class HomeEffects {
    constructor(actionStream, homeService) {
        this.actionStream = actionStream;
        this.homeService = homeService;
        this.loadData = this.actionStream.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_home_actions__WEBPACK_IMPORTED_MODULE_6__["LOAD_DATA"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((action) => action.payload), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])((type) => {
            return this.homeService
                .getData(type)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(data => new _actions_home_actions__WEBPACK_IMPORTED_MODULE_6__["LoadDataSuccess"]({ type, data })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])([new _actions_home_actions__WEBPACK_IMPORTED_MODULE_6__["LoadDataFail"]()])));
        }));
    }
};
...
const effects = [_home_effects__WEBPACK_IMPORTED_MODULE_0__["HomeEffects"]];
...
/* harmony import */ var _actions_home_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/home.actions */ "./src/app/home/store/actions/home.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_home_actions__WEBPACK_IMPORTED_MODULE_0__["LOAD_DATA_SUCCESS"]:
...
const getHomeRootState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('home');
...
const getHomeState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(_reducers__WEBPACK_IMPORTED_MODULE_1__["getHomeRootState"], (state) => (state ? state.home : null));
const getExperience = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getHomeState, (state) => state.experience);
const getSkills = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getHomeState, ({ skills }) => skills);
