...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent.prototype.ngOnInit = function () {
        ...
        this.contactService
            ...
            var isFail = _a.isFail, message = _a.message;
    ...
    ContactComponent.prototype.onSubmit = function () {
        ...
        this.result = null;
        var needs = this.contactForm.value.needs
            .map(function (x, i) { return x && _this.needs[i]; })
            .filter(function (x) { return !!x; })
            .join(', ');
        var contactFormValue = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.contactForm.value, { needs: needs || 'unspecified reason' });
        this.contactService.submitContactForm(contactFormValue);
    };
    ContactComponent.prototype.setForm = function () {
        this.contactForm = this.fb.group({
            name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            email: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email],
            occupation: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            needs: this.fb.array(this.needs.map(function (x) { return !1; })),
...
var ContactService = /** @class */ (function () {
    ...
    ContactService.prototype.getResult = function () {
        return this.result;
    };
    ContactService.prototype.submitContactForm = function (contactFormValue) {
        var _this = this;
